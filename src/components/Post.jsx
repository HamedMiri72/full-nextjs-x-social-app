    ...
    <div className="p-4 border-y-[1px] border-borderGray">
      ...
      <div className="flex items-center text-sm gap-2 text-textGray mb-2 font-bold">
        <div className='cursor-pointer'>
          ...
          >
            <path
              className="fill-textGray hover:fill-iconBlue"
      ...
      <div className="flex gap-4 ">
        ...
        <div className="flex-1 flex flex-col gap-2">
          ...
          <p>
            ...
            aliquid omnis? Libero dolores nostrum possimus natus, alias
            dignissimos similique qui error inventore quis placeat assumenda
            pariatur distinctio! Quod, labore numquam.
          </p>
